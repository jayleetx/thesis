...
We also obtain a precinct boundary shapefile from the Department [@noauthor_maps_nodate].
...
We also obtain a block group boundary shapefile from the Bureau [@noauthor_2010_nodate].
...
```{r echo=FALSE, fig.cap='Example regions for interpolation', out.width='6in'}
...
```{r echo = FALSE, out.width='6in', fig.cap = 'Proportion of non-Hispanic Asian residents'}
...
```{r, fig.cap = 'Sample error in intensive interpolation', warning=FALSE, out.width='6in'}
...
To choose which variables went into the final models produced, we used best subset selection on a training subset of half the data, and validated the models on the other half as a test set.
