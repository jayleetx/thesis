...
\NormalTok{source <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\KeywordTok{here}\NormalTok{(}\StringTok{'data'}\NormalTok{, }\StringTok{'source_zones'}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}\DataTypeTok{name =} \KeywordTok{c}\NormalTok{(}\StringTok{'D'}\NormalTok{,}\StringTok{'C'}\NormalTok{,}\StringTok{'A'}\NormalTok{,}\StringTok{'B'}\NormalTok{),}
            \DataTypeTok{lon =} \KeywordTok{map_dbl}\NormalTok{(geometry, }\OperatorTok{~}\KeywordTok{st_centroid}\NormalTok{(.x)[[}\DecValTok{1}\NormalTok{]]),}
            \DataTypeTok{lat =} \KeywordTok{map_dbl}\NormalTok{(geometry, }\OperatorTok{~}\KeywordTok{st_centroid}\NormalTok{(.x)[[}\DecValTok{2}\NormalTok{]]))}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{target <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\KeywordTok{here}\NormalTok{(}\StringTok{'data'}\NormalTok{, }\StringTok{'target_zones'}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{transmute}\NormalTok{(}\DataTypeTok{name =} \KeywordTok{c}\NormalTok{(}\StringTok{'Z'}\NormalTok{,}\StringTok{'X'}\NormalTok{,}\StringTok{'Y'}\NormalTok{),}
            \DataTypeTok{lon =} \KeywordTok{map_dbl}\NormalTok{(geometry, }\OperatorTok{~}\KeywordTok{st_centroid}\NormalTok{(.x)[[}\DecValTok{1}\NormalTok{]]),}
            \DataTypeTok{lat =} \KeywordTok{map_dbl}\NormalTok{(geometry, }\OperatorTok{~}\KeywordTok{st_centroid}\NormalTok{(.x)[[}\DecValTok{2}\NormalTok{]]))}
\end{Highlighting}
\end{Shaded}
