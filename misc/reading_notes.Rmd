...
"generally, overvotes increase slightly with RCV while undervotes decrease", that is "more people participate in down-ballot elections when jurisdictions comduct them via RCV, but these voters also make more mistakes" - the combination of these two factors leads to a small (statistically insignificant) decrease in these uncountable votes (Kimball).
